...
/// do get and do post for random gen data
    public static void testLiftRidePost() throws Exception {
        ...
        if (threaddetails.counter<=8){    //totalposts condition


            long begin = System.currentTimeMillis();  //doing posts
        ...
        //System.out.println("Status code: " + statusCode + "Response body: " + responseBody+dt+"ms");
            ...
            for(int i=0;i<threaddetails.list.size();i++){ //  join it into the main thread
...
class AudioClientTest{
    ...
    public static void main( String arg [] ) throws Exception{
     ...
     for(int i=1;i<=10;i++){  // creating extra threads if a thread is terminated
